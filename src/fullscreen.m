...
% de "Java Swing How to - Send the JFrame to front of screen" http://www.java2s.com/Tutorials/Java/Swing_How_to/JFrame/Send_the_JFrame_to_front_of_screen.htm
% para una lista de los defines de Java ver https://docs.oracle.com/javase/7/docs/api/constant-values.html#java.awt.event.WindowEvent.WINDOW_CLOSED

% ver 
% http://www.java2s.com/Tutorials/Java/Swing_How_to/JFrame/Send_the_JFrame_to_front_of_screen.htm
% https://docs.oracle.com/javase/7/docs/api/constant-values.html#java.awt.event.WindowEvent.WINDOW_CLOSED

if not(frame_java.isActive())
    %frame_java.setState(1) % JFrame.ICONIFIED=1) esto lo he quitado pq hace un efecto blink no deseado y con la siguiente linea esta OK
    frame_java.setState(0) % %JFrame.NORMAL=0
end

frame_java.pack
frame_java.repaint
frame_java.show
frame_java.setVisible(true) %AQDEBUG 12/10/2018 para reforzar que aparezca la ventana entre llamadas a la funcion fullscreen

% en general, para la doc de JFRAME ver https://docs.oracle.com/javase/7/docs/api/java/awt/Window.html#setAutoRequestFocus(boolean)
