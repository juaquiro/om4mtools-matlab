classdef DemodRetarPolPS6Step < Demodulator
    ...
    methods
        ...
        function this=Process(this, FPList)
            ...
            if not(iscell(FPList)) || length(FPList)~=6
                retMsg=[FPListName ' must be an cell array of 6 phase shifted images'];
