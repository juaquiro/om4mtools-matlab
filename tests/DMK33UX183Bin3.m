function out = DMK33UX183Bin3
% DMK33UX183Bin3 creates a video input object for a single DMK 33UX183
% camera via the tisimaq_r2013_64 adaptor, Y800 (1824x1216) [Binning 3x]
%
...
vidObj1=imaqCam.getVidFromName(adaptorName, name, vidFormat);
...
set(srcObj1, 'Brightness', 50);
set(srcObj1, 'Denoise', 0);
set(srcObj1, 'Exposure', 0.1);
set(srcObj1, 'ExposureAuto', 'Off');
set(srcObj1, 'GainAuto', 'Off');
set(srcObj1, 'Gain', 12.21);
