...
%   type the name of the code file, GVPCCam, at the MATLAB command prompt.
%   
%   The code file, GVPCCAM.M and its associated MAT-file, GVPCCAM.MAT (if
...
try
    MATvar = load('D:\user\AQ_SCC\Hg\OM4MMatlabUtils\ClassLib\TestStandardHW\GVPCCam');
    MATLoaded = true;
catch
...
% Configure properties whose values are saved in D:\user\AQ_SCC\Hg\OM4MMatlabUtils\ClassLib\TestStandardHW\GVPCCam.mat.
if (MATLoaded)
